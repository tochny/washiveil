...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 font-mono text-[0.75rem] tracking-[0.2em] uppercase text-faint', className)}
    {...props}
  />
))
